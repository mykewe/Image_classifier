...
top_k = st.number_input('Insert a number for the top most likely classes',min_value=1, max_value=5,value=1, step=1)
st.write('You want the top', top_k, 'most likely classes')
